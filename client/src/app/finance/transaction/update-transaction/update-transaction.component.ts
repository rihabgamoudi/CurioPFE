...
export class UpdateTransactionComponent implements OnInit {
  ...
  getCustomerById(id:number){
    this.FinanceService.findTransactionById(id).subscribe(data=>{
      this.transactionForm.get('nameForm.name')?.setValue(data.name);
      this.transactionForm.get('nameForm.description')?.setValue(data.description);
      this.transactionForm.get('stringStepper.ban')?.setValue(data.ban);
      this.transactionForm.get('stringStepper.checkNumber')?.setValue(data.checkNumber); 
      this.transactionForm.get('stringStepper.checkImage')?.setValue(data.checkImage);
      this.transactionForm.get('numberStepper.amount')?.setValue(data.amount);
      this.transactionForm.get('numberStepper.sourceId')?.setValue(data.sourceId);
      this.transactionForm.get('numberStepper.operationNumber')?.setValue(data.operationNumber); 
      this.transactionForm.get('bolleanStepper.isCompleted')?.setValue(data.isCompleted);
      this.transactionForm.get('bolleanStepper.isCredit')?.setValue(data.isCredit);
      this.transactionForm.get('bolleanStepper.isOver')?.setValue(data.isOver);
      this.transactionForm.get('date.dueDate')?.setValue(data.dueDate);
  ...
  submit(){ 
    ...
    this.FinanceService.editTansactionById(this.id,this.transaction).subscribe(
      data=>{
