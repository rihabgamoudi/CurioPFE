...
export class AddDevisComponent {
 ...
 Transactions:Transaction[]=[]
  ...
  constructor(private formBuilder: FormBuilder,private customerService:CustomerService,private productsService:ProductsService,private financeService:FinanceService,private devisService:DevisService) {
...
this.devis= new Devis()
  this.DevisDetail= new deviceDetail()
